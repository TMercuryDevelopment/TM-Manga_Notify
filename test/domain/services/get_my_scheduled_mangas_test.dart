...
import 'package:manga_notify/core/shared/domain/services/get_my_scheduled_mangas.dart';
import 'package:manga_notify/core/shared/failures/service/services_failures.dart';
...
void main() {
  ...
  test("Deve Retornar uma lista de Mangás previamente Agendados", () async {
    when(repository.getScheduledMangas())
